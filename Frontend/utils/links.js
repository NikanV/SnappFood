...
export const CURRENT_PRICES = prefix + '/current-prices/'
export const CONTACT_US = prefix + '/contact-us/'
export const FEEDBACK_AND_SUGGESTION = prefix + '/feedbacks-and-suggestions/'
export const GIFT_CARD = prefix + '/giftcard/'
export const POSITION_HELP = prefix + '/position-help/'
export const POSITION_TERMS = prefix + '/position-terms/'
...
export const CURRENCY_MARKETS = prefix + '/policies/markets/'
...
export function PRICE_ALERTS(currency, marketSymbol) {
    return `${APP_ROOT}price-alerts/${currency}-${marketSymbol}/`
}
...
export const SHETAB_DEPOSIT_RESULT = PANEL_ROOT + 'balance/deposit/rls/?result=show'
export const PANEL_PRICES = PANEL_ROOT + 'prices/'
export function DEPOSIT(currency) {
    return `${PANEL_ROOT}balance/deposit/${currency}/`
}
export function TURNOVER(type) {
    return `${PANEL_ROOT}turnover/${type || 'transaction'}/`
}
export function ORDERS(type) {
    return `${PANEL_ROOT}orders/${type || 'open-orders'}/`
}
...
export function FORCE_TO_PANEL_ROOT(url) {
    return url.replace(APP_ROOT, PANEL_ROOT)
}
